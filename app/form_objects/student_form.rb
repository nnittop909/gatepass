class StudentForm
  ...
  validates :id_number, :tag_uid, :role, :course_id, :first_name, :last_name, :full_name, :g_mobile, :relation, :municipality, :province, :g_municipality, :g_province, presence: true
